// TODO: waiting untagged @unboxed rescript feature released
// @unboxed type t = String(string) | ArrayBuffer(arrayBufferT)
...
external arrayBuffer: Js.TypedArray2.array_buffer => t = "%identity"
